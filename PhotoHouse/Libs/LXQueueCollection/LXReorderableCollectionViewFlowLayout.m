...
- (void)setupCollectionView {
    ...
    _panGestureRecognizer = [[UIPanGestureRecognizer alloc] initWithTarget:self
                                                                    action:@selector(handlePanGesture:)];/*handlePanGesture:*/
...
- (void)handleLongPressGesture:(UIPanGestureRecognizer *)gestureRecognizer {//(UILongPressGestureRecognizer *)gestureRecognizer {
