...
@implementation IPhone4Strategy
-(UIImage *)showcaseImage
{
    return [UIImage imageNamed:@"Case4_back"];
}
...
-(NSArray *)createAndAddMergedImage:(UIImage *)previewImage
{
    ...
    //NSLog(@"image: %@", merge);
    PrintImage *merged = [[PrintImage alloc] initMergeImage:merge withName:@"merge_iphone4" andUploadUrl:nil];
